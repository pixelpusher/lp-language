import { Logger as e } from "liveprinter-utils";
...
var t = Object.create, n = Object.defineProperty, r = Object.getOwnPropertyDescriptor, i = Object.getOwnPropertyNames, a = Object.getPrototypeOf, o = Object.prototype.hasOwnProperty, s = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), c = (e, t, a, s) => {
	...
	(function(e, n) {
		...
		i.prototype.reset = function(e, t) {
			...
			} else return t + " at index " + (this.index - 1);
			function s(e, t) {
				var n = String(e);
...
function x(e, t = 4) {
	...
	} else if (e === "]") i.length > 1 && i.pop();
	else if (e.startsWith("!")) {
		let t = parseInt(e.slice(1), 10), n = i[i.length - 1];
		if (n.length > 0 && !isNaN(t) && t > 0) {
			let e = n.pop();
			for (let r = 0; r < t; r++) n.push(e);
		}
	} else i[i.length - 1].push(e);
	function a(e) {
		if (Number.isInteger(e)) return e + "b";
		for (let t = 2; t <= 64; t *= 2) {
			let n = Math.round(e * t);
			if (Math.abs(e - n / t) < .001) return n === 1 ? `1/${t}b` : `${n}/${t}b`;
		}
		return e.toFixed(3).replace(/\.?0+$/, "") + "b";
	}
	let o = [];
	function s(e, t) {
		if (Array.isArray(e)) {
			let n = 0, r = e.map((e) => {
				let t = 1;
				return typeof e == "string" && (e.includes("@") ? t = parseFloat(e.split("@")[1]) || 1 : e.includes("/") && (t = parseFloat(e.split("/")[1]) || 1)), n += t, {
					child: e,
					weight: t
				};
			});
			for (let { child: e, weight: i } of r) s(e, i / n * t);
		} else {
			let n = e, r = t;
			if (n.includes("@") && (n = n.split("@")[0]), n.includes("/") && (n = n.split("/")[0]), n.includes("*")) {
				let [e, t] = n.split("*"), i = e === "~" ? "-" : e, s = parseInt(t, 10);
				if (!isNaN(s) && s > 0) {
					let e = a(r / s);
					for (let t = 0; t < s; t++) o.push([i, e]);
					return;
				}
			}
			let i = n === "~" ? "-" : n;
